                ...
                {this.state.repo && 
                    (
                        <div className="single-repository-content">
                            ...
                            <div className="single-repositories-info-container">
                                <span>{this.state.repo.language}</span>
                                <div className="single-repositories-info-item">
                                    ...
                                    <span>{this.state.repo.stars}</span>
                                </div>
                                <div className="single-repositories-info-item">
